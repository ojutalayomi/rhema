...
echo -e "${BLUE}Rhema Windows Release Creation${NC}"
echo "=============================="
...
echo ""
echo -e "${BLUE}Preparing Windows release $TAG...${NC}"
...
echo ""
echo -e "${GREEN}Windows release $TAG created successfully${NC}"
echo ""
echo "What happens next:"
echo "1. GitHub Actions will run .github/workflows/release-windows.yml for this tag"
echo "2. Windows release assets (.msi/.exe) will be uploaded to the GitHub Release for $TAG"
if [[ -n "$REPO_PATH" ]]; then
